...
export const Logotype = ({ color }: any) => {
   const Logo = () => <svg fill={color} version="1.1" id="Capa_1" 
      xmlns="http://www.w3.org/2000/svg" 
      width="70px" height="70px" viewBox="0 0 370.848 370.848">
      <g>
   ...
   let logotypeSubtitleColor;
   if (color === '#ffffff') {
      logotypeSubtitleColor = 'logotype__subtitle-white'
   } else {
      logotypeSubtitleColor = 'logotype__subtitle' 
   }
   return (
      <div className="brand__item logotype">
         ...
         <div>
            ...
            <p className={logotypeSubtitleColor}>салон красоты</p>
         </div>
      </div>
   )
}